...
# --- নতুন: লজিক পলিশ (UI ডিসেবল করার জন্য) ---
...
with st.sidebar:
    ...
    video_b64 = get_asset_as_base64("assets/ai_brain.mp4")
    if video_b64:
        video_html = f"""
        <video autoplay loop muted width="100%" style="border-radius: 8px; max-width: 250px;">
        ...
        st.warning("⚠️ AI Brain MP4 not found in assets folder.")
...
with tab1:
    ...
    with st.container(border=True):
        ...
        with col_mic:
            st.write(" ") 
            # ফিক্স: প্রসেসিং চলাকালীন মাইক ডিসেবল করা
        ...
        with col_text:
            # ফিক্স: প্রসেসিং চলাকালীন টেক্সটবক্স ডিসেবল করা
            st.text_area(
        ...
        # ফিক্স: প্রসেসিং চলাকালীন বাটন ডিসেবল করা
        if st.button("Analyze Command 🧠", use_container_width=True, disabled=st.session_state["processing"]):
            ...
            def run_analysis():
                ...
                if not user_input:
                    ...
                    st.session_state["processing"] = False # UI আনলক করা
                    return
        ...
        with st.container(border=True):
            if plan.action == "CHECK_BALANCE":
                ...
                if audit_status == "APPROVED":
                    ...
                    # ফিক্স: প্রসেসিং চলাকালীন পিন ইনপুট ডিসেবল করা
...
st.caption("© 2025 Team Believer") # আপনার অনুরোধ করা ব্র্যান্ডেড ফুটারimport streamlit as st
import requests
import pandas as pd
from datetime import datetime
import matplotlib.pyplot as plt
...
st.markdown("---")
st.caption("Powered by Arc + OpenAI + ElevenLabs | Built by Zahid Hasan 🚀")
st.caption("© 2025 Team Believer") # আপনার অনুরোধ করা ব্র্যান্ডেড ফুটার
